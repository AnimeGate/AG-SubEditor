    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[85vh] max-w-[min(92vw,720px)] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {t("wypalarkaEncodingSettingsDesc")}
          </DialogDescription>
        </DialogHeader>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <ul className="text-muted-foreground space-y-1.5">
                        <li>
                          ...
                          – {t("wypalarkaProfileHelp1080p")}
                        </li>
                        <li>
                          <span className="text-foreground font-medium">
                            1080p (downscale)
                          </span>{" "}
                          – {t("wypalarkaProfileHelp1080pDownscale")}
                        </li>
                        <li>
                          <span className="text-foreground font-medium">
                            1080p Cinema
                          </span>{" "}
                          – {t("wypalarkaProfileHelp1080pCinema")}
                        </li>
                        <li>
                          <span className="text-foreground font-medium">
                            4K
                          </span>{" "}
                          – {t("wypalarkaProfileHelp4k")}
                        </li>
                        <li>
                          <span className="text-foreground font-medium">
                            4K Cinema
                          </span>{" "}
                          – {t("wypalarkaProfileHelp4kCinema")}
                        </li>
                      </ul>
                    </div>
                  </TooltipContent>
              ...
              groups={[
                {
                  ...
                  items: [
                    {
                      value: "1080p",
                      label: t("wypalarkaProfile1080p") as string,
                    },
                    {
                      value: "1080p_downscale",
                      label: t("wypalarkaProfile1080pDownscale") as string,
                    },
                    {
                      value: "1080p_cinema",
                      label: t("wypalarkaProfile1080pCinema") as string,
                    },
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    {
                      value: "4k_cinema",
                      label: t("wypalarkaProfile4kCinema") as string,
                    },
                  ],
                },
                {
                  ...
                  items: [
                    {
                      value: "custom",
                      label: t("wypalarkaProfileCustom") as string,
                    },
                  ],
                },
              ]}
                ...
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="p1">
                          {t("wypalarkaEncoderPresetP1")}
                        </SelectItem>
                        <SelectItem value="p2">
                          {t("wypalarkaEncoderPresetP2")}
                        </SelectItem>
                        <SelectItem value="p3">
                          {t("wypalarkaEncoderPresetP3")}
                        </SelectItem>
                        <SelectItem value="p4">
                          {t("wypalarkaEncoderPresetP4")}
                        </SelectItem>
                        <SelectItem value="p5">
                          {t("wypalarkaEncoderPresetP5")}
                        </SelectItem>
                        <SelectItem value="p6">
                          {t("wypalarkaEncoderPresetP6")}
                        </SelectItem>
                        <SelectItem value="p7">
                          {t("wypalarkaEncoderPresetP7")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    <p className="text-muted-foreground text-xs">
                      {t("wypalarkaEncoderPresetDesc")}
                    </p>
                  </div>
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="cq">
                          {t("wypalarkaRateControlCQ")}
                        </SelectItem>
                        <SelectItem value="vbr">
                          {t("wypalarkaRateControlVBR")}
                        </SelectItem>
                        <SelectItem value="vbr_hq">
                          {t("wypalarkaRateControlVBRHQ")}
                        </SelectItem>
                        <SelectItem value="cbr">
                          {t("wypalarkaRateControlCBR")}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    <p className="text-muted-foreground text-xs">
                      {t("wypalarkaRateControlDesc")}
                    </p>
                  </div>
                  {(settings.qualityMode === "cq" ||
                    settings.qualityMode === "vbr_hq" ||
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <Label htmlFor="temporal-aq">
                        {t("wypalarkaTemporalAQ")}
                      </Label>
                    </div>
                  </div>
                  <p className="text-muted-foreground text-xs">
                    {t("wypalarkaSpatialAQDesc")}
                  </p>
                  <p className="text-muted-foreground text-xs">
                    {t("wypalarkaTemporalAQDesc")}
                  </p>
                  <div className="space-y-1">
