...
export function exposeSettingsContext() {
  contextBridge.exposeInMainWorld("settingsAPI", {
    ...
    updateOutput: async (partial: any) => ipcRenderer.invoke(SETTINGS_CHANNELS.UPDATE_OUTPUT, partial),
    selectOutputFolder: async () => ipcRenderer.invoke(SETTINGS_CHANNELS.SELECT_OUTPUT_FOLDER),
