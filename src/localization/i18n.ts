  ...
  resources: {
    pl: {
      translation: {
        ...
        wypalarkaEncoderCodecDesc: "H.264: najlepsza kompatybilność. HEVC (H.265): mniejszy rozmiar przy podobnej jakości, lecz wolniejsze odtwarzanie na starszych urządzeniach.",
    ...
    en: {
      translation: {
        ...
        wypalarkaEncoderCodecDesc: "H.264: best compatibility. HEVC (H.265): smaller files at similar quality but slower decode on older devices.",
        wypalarkaEncoderPreset: "Preset",
